...
public class SearchVO {
	...
	public SearchVO() { //크롤링 데이터 컬럼 값 범위에 따라 초기값 수정 비교 
		this.price_min = 0;
		...
		this.range1 = 0; //Oracle Rownum =1, MySQL limit =0
		this.range2 = 12; //Oracle Rownum: 최대 데이터 조회 범위, MySQL Limit : 더 보여질 데이터 개수 
	}
