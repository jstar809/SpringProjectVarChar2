...
<div class="row">
   <c:forEach var="c" begin="0" end="${(fn:length(datas))}" items="${datas}">
          ...
          <div class="col-md-4">
            ...
            <!-- 이미지 -->
             ...
             <!-- 제목 -->
              <div class="text">
                <h2 class="mb-0">
                  <a href="detail.do?cnum=${c.cnum}">${c.cnum}</a>
                </h2>
                <!-- 키로수 -->
                ...
                <p class="d-flex mb-0 d-block">
                  ...
                  <a href="detail.do?cnum=${c.cnum}" class="btn btn-secondary py-2 ml-1"
                    >자세한 정보</a>
                </p>
